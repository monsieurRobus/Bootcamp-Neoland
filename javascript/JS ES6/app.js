...
let suma = exams.reduce((sum,examen)=>
		sum+examen.score
	,0)
console.log(suma)
...
let aprobados = exams.filter(exam => exam.score >= 5).reduce((sumaNotas,exam)=>sumaNotas+exam.score,0)
console.log(aprobados)

// 7.3 Dado el mismo array, haz la media de las notas de todos los examenes .reduce().

let media = exams.reduce((suma,exam)=>suma+exam.score,0)/exams.length
console.log(media)
...
const cantidadRPG = rpgGames.length;
const mediaGames = rpgGames.reduce((suma,game)=>suma+game.score,0)/cantidadRPG;
